...
```
BECAUSE YOU USED `stringsAsFactors = TRUE` WHEN YOU READ THE DATA IN, LINES 26-29 ARE NOT DOING ANYTHING
...
ggplot(Try,aes(x=avg_age,y=avg_candy_pieces,colour=Type))+
  ...
  theme_bw()
```
YOUR PLOT IS MISSING TWO SCARY POINTS AND 1 NOT SCARY POINT BECAUSE YOU DIDN'T USE  `na.rm = T` WHEN CALCULATING THE MEANS IN Try. See key for details.
